...
import org.ytmf.creational.factory.method.v1.impl.*;
...
public class ResourceLoader2 {
    ...
    static {
        RESOURCE_FACTORY_CACHE.put("http", new HttpResourceFactory());
        RESOURCE_FACTORY_CACHE.put("file", new FileResourceFactory());
        RESOURCE_FACTORY_CACHE.put("classpath", new ClasspathResourceFactory());
        RESOURCE_FACTORY_CACHE.put("ftp", new FTPResourceFactory());
        RESOURCE_FACTORY_CACHE.put("default", new DefaultResourceFactory());
